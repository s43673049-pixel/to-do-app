<h1> To-Do App</h1>
<p> A simple and responsive To-Do List Application that helps users organize tasks efficiently. Users can add, edit, mark task as completed, and delete tasks. This project demonstrates core front-end development skills using modern web technologies.
</p>
<h2>🚀 Features</h2>
<ul>
  <li> ➕ Add new tasks </li>
...
<ul>
  ...
  <li><strong>CSS3</strong> – Styling and responsive layout</li>
